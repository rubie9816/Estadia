<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bitacora.aspx.cs" Inherits="EstadiaMWE.Bitacora" %>
...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtFecha" runat="server" CssClass="css-input" TextMode="Date" OnTextChanged="txtFecha_TextChanged" AutoPostBack="true" onkeypress="return false;" onpaste="return false"></asp:TextBox>
...
&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnLimpiar"  CssClass="myButton" runat="server" BackColor="#33CCFF" Height="42px" OnClick="btnLimpiar_Click" Text="Limpiar" Width="112px" />
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnExportar"  CssClass="myButton" runat="server" BackColor="#FFCC66" Height="42px" Text="Exportar" Width="112px" OnClick="btnExportar_Click" />
        <br />
